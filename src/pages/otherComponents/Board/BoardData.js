...
const BoardData = [
  ...
  {
    name: "Boris",
    title: <h1 className={`text-sm text-[#fdb063] font-mono`}>Build Director</h1>,
    desc: "",
    background: Boris,
  },
  {
    name: "Enes",
    title: <h1 className={`text-sm text-[#c92e2e] font-mono`}>Assistant Build Director</h1>,
    desc: "",
    background: Farhan,
  },
  {
  ...
  {
    name: "Chair",
    title: <h1 className={`text-sm text-[#c4f3bd] font-mono`}>Biology Director</h1>,
    desc: "",
    background: Chair,
  },
  {
    name: "Johann",
    title: <h1 className={`text-sm text-[#b6e8ff] font-mono`}>Math Director</h1>,
    desc: "",
    background: Farhan,
  },
  {
    name: "Will",
    title: <h1 className={`text-sm text-[#ffcc99] font-mono`}>Earth Science Director</h1>,
    desc: "",
    background: Farhan,
  },
  {
    name: "Anthony",
    title: <h1 className={`text-sm text-[#e6bdf5] font-mono`}>Chemistry Director</h1>,
    desc: "",
    background: Farhan,
  },
];
