...
const About = () => {
  return (
    <Page>
      ...
      <Divider />
      <h1 className="text-4xl font-bold border-t-4 border-yellow-400 pt-[20px] mb-[50px] self-start">
        Our Achievements
      </h1>
      ...
      <Divider />
      <div className="text-4xl font-bold border-t-4 border-yellow-400 pt-[20px] mb-[50px] self-start">
        Meet the board
      </div>
      <Board />
